...
import c1 from '../assets/color.png';
import s1 from '../assets/size.png';
        ...
        <Container>
            ...
            <div className="flex justify-between items-center pb-[140px] ">
                ...
                <div className="w-[40%] ">
                    ...
                    <div className="flex gap-x-[24px] py-6 ">
                        <h3>
                            Colors:
                        </h3>
                        <img src={c1} alt="" />
                  ...
                  <button type="button" id="increment-button" data-input-counter-increment="bedrooms-input" class="bg-white text-black border-black border-[1px] rounded-e-lg p-3 h-11 focus:ring-gray-100 focus:ring-2 focus:outline-none">
                    <svg class="w-3 h-3 dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16"/>
                        ...
                        <Link to="/" className="font-pop font-normal text-white text-[16px] px-[48px] py-[10px] rounded-lg bg-[#DB4444] hover:bg-black ease-in-out duration-300  ">
                            Buy Now
                        </Link>
                        <FiHeart className="text-[20px] "  />
                    </div>
                    <div>
                        <div className="border-black border-[1px] rounded-lg mt-[30px] ">
